...
def upgrade() -> None:
    ...
    op.create_index('ix_jobs_company_title', 'jobs', ['company_normalized', 'title_normalized'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('work_arrangement_preference', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('parent_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('documents.id', ondelete='SET NULL'), nullable=True),
        sa.Column('extracted_text', sa.Text(), nullable=False),
        sa.Column('parsed', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('is_primary', sa.Boolean(), nullable=False),
        sa.Column('generated_for_job_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('jobs.id', ondelete='SET NULL'), nullable=True),
    ...
    op.create_index('ix_job_source_subscriptions_user_id', 'job_source_subscriptions', ['user_id'], unique=False)
    ...
    op.create_index('ix_platform_authorizations_user_id', 'platform_authorizations', ['user_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('recommended_resume_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('documents.id', ondelete='SET NULL'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('user_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
        sa.Column('job_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('jobs.id', ondelete='CASCADE'), nullable=False),
        sa.Column('match_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('job_matches.id', ondelete='SET NULL'), nullable=True),
        ...
        sa.Column('screenshot_document_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('documents.id', ondelete='SET NULL'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('source_fact_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('career_facts.id', ondelete='SET NULL'), nullable=True),
    ...
    op.create_index('ix_application_answers_application_id', 'application_answers', ['application_id'], unique=False)
    ...
    op.create_index('ix_review_tasks_application_id', 'review_tasks', ['application_id'], unique=False)
    ...
    op.create_index('ix_submission_attempts_application_id', 'submission_attempts', ['application_id'], unique=False)
    op.create_index('ix_submission_attempts_outcome', 'submission_attempts', ['outcome'], unique=False)
